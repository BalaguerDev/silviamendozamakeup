export const courseList = [
    ...
    },
    {
        ...
        longDescription: "Descubre el mundo del peinado y los recogidos. Desde estilos clásicos hasta las últimas tendencias, te enseñaremos todo lo que necesitas saber para crear looks personalizados y duraderos.",
        whatYouWillLearn: [
            "Técnicas avanzadas de trenzado y recogido.",
            "Selección de herramientas y productos profesionales.",
            "Adaptación de peinados a diferentes tipos de cabello y rostros.",
            "Consejos para crear peinados para eventos especiales.",
        ],
        forWhom: "Ideal para novias, madrinas, invitadas a bodas y cualquier persona que quiera aprender a peinarse como una profesional.",
        durationPrice: ["1 hora - 25,00€", "2 horas - 40,00€"],
        materials: "Incluye kit de herramientas básico (tijeras, pinzas, etc.)",
        location: "Barcelona",
        targetAudience: "Novias, madrinas, amantes de la belleza y profesionales en formación.",
